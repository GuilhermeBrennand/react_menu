                ...
                <table className="table align-middle gs-0 gy-4 my-0">
                    ...
                    <tbody>
                        <tr data-kt-pos-element="item" data-kt-pos-item-price="33">
                            <td className="pe-0">
                                <div className="d-flex align-items-center">
                                    <img src="src\_metronic\assets\media\stock\food/img-2.jpg" className="w-50px h-50px rounded-3 me-3" alt="" />
                        ...
                        <tr data-kt-pos-element="item" data-kt-pos-item-price="7.5">
                            <td className="pe-0">
                                <div className="d-flex align-items-center">
                                    <img src="src\_metronic\assets\media\stock\food/img-9.jpg" className="w-50px h-50px rounded-3 me-3" alt="" />
                        ...
                        <tr data-kt-pos-element="item" data-kt-pos-item-price="13.5">
                            <td className="pe-0">
                                <div className="d-flex align-items-center">
                                    <img src="src\_metronic\assets\media\stock\food/img-3.jpg" className="w-50px h-50px rounded-3 me-3" alt="" />
